...
variable "instance_source_ocids" {
  type = map(any)
  default = {
    Linux    = "ocid1.image.oc1.ca-toronto-1.aaaaaaaaauuerht2mnfsjvzhaxcvbzmrgztqnhlpncg2vdnlgk6qedlaqpga"
    Windows  = "ocid1.image.oc1.ca-toronto-1.aaaaaaaal5vw2vfnw75vufo74vcsn5jcmt7vltxaozmvixs2ltwmagcv6wza"
